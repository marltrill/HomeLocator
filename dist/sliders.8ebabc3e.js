...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/sliders.js":[function(require,module,exports) {
var classification_search = function classification_search(feature, resolution) {
...
outputUni.innerHTML = sliderUni.value * 1; // Update the current slider value (each time you drag the slider handle)
...
outputSchools.innerHTML = sliderSchools.value * 1; // Update the current slider value (each time you drag the slider handle)
...
outputParks.innerHTML = sliderParks.value * 1; // Update the current slider value (each time you drag the slider handle)
